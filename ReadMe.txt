...
##Authorization Server: Responsible for authenticating the user and granting access tokens.
##Resource Server: Hosts the protected resources and validates the access tokens.
##Client: Represents the application that requests access to the resources on behalf of the user.
